    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-dark-300 rounded-2xl p-8 border border-dark-100">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div class="flex items-center justify-between">
            <label class="flex items-center">
              <input type="checkbox" class="w-4 h-4 rounded border-dark-100 bg-dark-400 text-primary-600 focus:ring-primary-500" />
              <span class="ml-2 text-sm text-gray-400">Remember me</span>
            </label>
            <a href="#" class="text-sm text-primary-500 hover:text-primary-400">Forgot password?</a>
          </div>
        ...
        <div class="space-y-3">
          ...
          <button
            :disabled="isLoading"
            class="w-full py-3 bg-dark-400 hover:bg-dark-200 border border-dark-100 rounded-lg text-white font-semibold flex items-center justify-center space-x-2 transition"
          >
        ...
        <p class="mt-6 text-center text-gray-400">
          ...
          <router-link to="/register" class="text-primary-500 hover:text-primary-400 font-semibold">
            Sign up
          </router-link>
        </p>
      </div>
